...
public class RandomCharacters extends JFrame implements ActionListener {
    ...
    public RandomCharacters() {
        ...
        for (int count = 0; count < SIZE; count++) {
            ...
            JLabel timeLabel = new JLabel(); // create JLabel
            timeLabel.setBackground(Color.CYAN); // set color
            timeLabel.setOpaque(true); // set JLabel to be opaque
            this.add(timeLabel); // add JLabel to JFrame

            // create a new RunnableObject
            randomCharacters[count] = new RunnableObject(lockObject, outputJLabel, timeLabel, checkboxes[count]);
